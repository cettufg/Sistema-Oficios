...
class LembreteOficio extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Atenção!')
            ->greeting('Olá, '. $this->user->name.' existe um ofício que precisa de sua atenção!')
            ->line('Abaixo você pode conferir os detalhes do ofício.')
