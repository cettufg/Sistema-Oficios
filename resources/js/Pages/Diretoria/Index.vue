            ...
            <div class="">
                <div class="tw-overflow-hidden">
                    <div class="tw-flex tw-justify-between tw-mx-4">
                        ...
                        <Link :href="route('diretoria.create')" class="tw-px-3 tw-py-2 tw-text-white tw-rounded-lg tw-bg-primary hover:tw-bg-[#031447] tw-flex tw-items-center tw-justify-center">
...
const rows = ref(props.diretores);
