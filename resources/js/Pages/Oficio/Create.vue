                    ...
                    <q-tab-panels v-model="tab" animated>
                        <q-tab-panel name="oficio">
                            ...
                            <div class="tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4" v-if="form.tipo_oficio == 'Recebido'">
                                ...
                                <div>
                                    <label for="" class="tw-flex tw-items-center"><span v-if="form.tipo_oficio == 'Recebido'">Origem</span> <span v-else>Destinatário</span><Icon class="tw-text-red-500 tw-text-xs" icon="mdi:required" /></label>
                                    <q-select
