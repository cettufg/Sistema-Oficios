...
<html>
    <head>
        ...
        <title>Ofício - {{ $oficio->numero_oficio }}</title>
    ...
    <body>
        <div class="container">
            ...
            <div>
                <p class="destaque">Olá, existe um novo ofício cadastrado no sistema.</p>
                <p>Abaixo você pode conferir um resumo do ofício</p>
            </div>
            <div class="details">
                <div class="row">
                    <div>
